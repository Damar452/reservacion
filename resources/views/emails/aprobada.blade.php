                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p5b">
                                                                                        ...
                                                                                        <?php
                                                                                                ...
                                                                                                echo \Carbon\Carbon::parse($union->fecha)->formatLocalized('%A %d de %B de %Y')
                                                                                        ?>
                                                                                       con horario de {{date('g:i A',strtotime($union->hora_inicio))}} a {{date('g:i A',strtotime($union->hora_fin))}} en la {{$union->sede}} ha sido aprobada, se le ha asignado el salon: {{$union->salon}}</p>
                                                                                    </td>
                                                                                </tr>
